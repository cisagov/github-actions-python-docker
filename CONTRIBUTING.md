...
issue](https://github.com/cisagov/github-actions-python-docker/issues) in this
...
request](https://github.com/cisagov/github-actions-python-docker/pulls), you will
...
```console
cd github-actions-python-docker
pyenv virtualenv <python_version_to_use> github-actions-python-docker
pyenv local github-actions-python-docker
